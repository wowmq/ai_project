...
# 16개 mbti별 완벽한 5개 게임 딕셔너리 데이터 (안정적인 Unsplash 저작권 무료 이미지로 전면 교체)
mbti_games = {
    "ISTJ": [
        ...
        {"name": "풋볼매니저 (FM)", "style": "방대한 데이터를 분석하고 구단을 관리하는 본격 과몰입 경영", "mode": "솔로 전용", "image": "https://images.unsplash.com/photo-1508098682722-e99c43a406b2?q=80&w=600&auto=format&fit=crop"},
        {"name": "유로 트럭 시뮬레이션 2", "style": "교통 법규를 준수하며 안전하게 화물을 운송하는 평화로운 배달", "mode": "솔로 (멀티 가능)", "image": "https://images.unsplash.com/photo-1601584115197-04ecc0da31d7?q=80&w=600&auto=format&fit=crop"},
    ...
    "ISFJ": [
        ...
        {"name": "언패킹 (Unpacking)", "style": "이삿짐을 정해진 자리에 차분히 정리하며 안정감을 얻는 게임", "mode": "솔로 전용", "image": "https://images.unsplash.com/photo-1588046130717-0eb0c9a3ba15?q=80&w=600&auto=format&fit=crop"},
        {"name": "가든 인", "style": "나만의 아늑한 방에서 아기자기한 식물들을 정성껏 키우는 힐링", "mode": "솔로 전용", "image": "https://images.unsplash.com/photo-1545241047-6083a3684587?q=80&w=600&auto=format&fit=crop"},
        {"name": "하우스 플리퍼", "style": "더러운 집을 깨끗하게 청소하고 인테리어를 개조하는 보람", "mode": "솔로 전용", "image": "https://images.unsplash.com/photo-1581858726788-75bc0f6a952d?q=80&w=600&auto=format&fit=crop"},
    ...
    "INFJ": [
        ...
        {"name": "오리와 도깨비불", "style": "한 편의 아름다운 동화 속 주인공이 되어 감동적인 서사를 탐험", "mode": "솔로 전용", "image": "https://images.unsplash.com/photo-1500622944204-b135684e99fd?q=80&w=600&auto=format&fit=crop"},
        ...
        {"name": "왓 리메인즈 오브 에디스 핀치", "style": "한 가문의 비극적인 이야기를 독특한 연출로 탐험하는 예술 게임", "mode": "솔로 전용", "image": "https://images.unsplash.com/photo-1513694203232-719a280e022f?q=80&w=600&auto=format&fit=crop"}
    ],
    "INTJ": [
    ...
    "ISTP": [
        {"name": "마인크래프트", "style": "도구를 만들고 세상을 내 마음대로 개조하는 진정한 자유도", "mode": "솔로 & 멀티 모두 지원", "image": "https://images.unsplash.com/photo-1605901309584-818e25960a8f?q=80&w=600&auto=format&fit=crop"},
        ...
        {"name": "사이버펑크 2077", "style": "내 마음대로 신체를 개조하고 미래 도시를 누비는 액션 RPG", "mode": "솔로 전용", "image": "https://images.unsplash.com/photo-1542838132-92c53300491e?q=80&w=600&auto=format&fit=crop"},
    ...
    "ISFP": [
        ...
        {"name": "데이브 더 다이버", "style": "낮에는 평화롭게 바다를 탐험하고 밤에는 초밥집을 운영하는 재미", "mode": "솔로 전용", "image": "https://images.unsplash.com/photo-1544551763-46a013bb70d5?q=80&w=600&auto=format&fit=crop"},
        ...
        {"name": "슬라임 랜처", "style": "말랑말랑한 슬라임들을 수집하고 키우는 귀여운 농장 경영", "mode": "솔로 전용", "image": "https://images.unsplash.com/photo-1558591710-4b4a1ae0f04d?q=80&w=600&auto=format&fit=crop"}
    ],
    "INFP": [
        {"name": "스카이: 빛의 아이들", "style": "몽환적인 하늘을 날아다니며 평화를 전파하는 감성 끝판왕", "mode": "솔로 & 멀티 모두 지원", "image": "https://images.unsplash.com/photo-1499209974431-9dddcece7f88?q=80&w=600&auto=format&fit=crop"},
        {"name": "오모리 (OMORI)", "style": "꿈과 현실을 오가며 내면의 깊은 상처와 기억을 마주하는 RPG", "mode": "솔로 전용", "image": "https://images.unsplash.com/photo-1518609878373-06d740f60d8b?q=80&w=600&auto=format&fit=crop"},
        {"name": "투 더 문", "style": "기억을 바꾸어 소원을 들어주는 감동적인 스토리 중심 게임", "mode": "솔로 전용", "image": "https://images.unsplash.com/photo-1532693322450-2cb5c511067d?q=80&w=600&auto=format&fit=crop"},
    ...
    "INTP": [
        {"name": "포탈 시리즈", "style": "물리학 법칙을 이용해 공간을 넘나드는 명작 퍼즐 해결", "mode": "솔로 (2편은 멀티 가능)", "image": "https://images.unsplash.com/photo-1506318137071-a8e063b4bec0?q=80&w=600&auto=format&fit=crop"},
        ...
        {"name": "탈로스 법칙", "style": "인공지능 로봇이 되어 고대 유적에서 고난이도 물리 퍼즐을 푸는 게임", "mode": "솔로 전용", "image": "https://images.unsplash.com/photo-1600585154340-be6161a56a0c?q=80&w=600&auto=format&fit=crop"},
    ...
    "ESTP": [
        ...
        {"name": "오버워치 2", "style": "내가 영웅이 되어 팀원들과 빠른 템포로 경기를 리드하는 하이퍼 슈팅", "mode": "멀티 전용", "image": "https://images.unsplash.com/photo-1612287230202-1bf1d85d1bdf?q=80&w=600&auto=format&fit=crop"},
    ...
    "ESFP": [
        ...
        {"name": "로블록스", "style": "매일 새로운 미니게임과 맵에서 친구들과 우당탕탕 노는 놀이터", "mode": "멀티 전용", "image": "https://images.unsplash.com/photo-1606144042614-b2417e99c4e3?q=80&w=600&auto=format&fit=crop"},
    ...
    "ENTP": [
        {"name": "어몽 어스", "style": "화려한 말빨과 심리전으로 상대를 속이고 추리하는 마피아 전략", "mode": "멀티 전용", "image": "https://images.unsplash.com/photo-1614624532983-4ce03382d63d?q=80&w=600&auto=format&fit=crop"},
        ...
        {"name": "플레이트 업 (PlateUp!)", "style": "요리도 하고 가게 동선도 내 마음대로 개조하며 협동하는 식당 로그라이크", "mode": "멀티 권장", "image": "https://images.unsplash.com/photo-1556910103-1c02745aae4d?q=80&w=600&auto=format&fit=crop"},
...
if user_mbti:
    ...
    for idx, game in enumerate(games):
        ...
        # 주소가 유효하지 않거나 일시적 차단이 생겨도 웹앱이 죽지 않도록 안전 패키징 적용
        try:
            st.image(game['image'], caption=f"{game['name']} 모티브 비주얼", use_container_width=True)
        except Exception:
    ...
    st.success("이제 모든 이미지가 엑박 없이 아주 깔끔하게 출력될 거야! 🚀")
