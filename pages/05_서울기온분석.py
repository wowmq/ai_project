...
@st.cache_data
def load_data():
    # 한국어 CSV 파일의 다양한 인코딩 형식 대응 ('utf-8', 'cp949', 'euc-kr', 'utf-8-sig')
...
try:
    ...
    st.error("📂 `seoul.csv` 파일을 찾을 수 없습니다. 대시보드 스크립트와 동일한 루트 폴더 혹은 지정된 경로에 데이터를 업로드해 주세요.")
